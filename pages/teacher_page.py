...
class TeacherPage(General, Helper):
    ...
    def push_create_chat_with_user(self):
        selector = self.browser.find_element(*TeacherLocators.BUTTON_CREATE_CHAT_WITH_USER)
        selector.click()
    ...
    def should_be_item_begin_chat(self):
        assert self.check_exists_element(*TeacherLocators.TEXT_BEGIN_CHAT), "Новый чат не создан"
