...
from .locators import StartKionLocators
from .general import General
from .general import Helper

class StartPageKion(General, Helper):
    ...
    #     assert "kion.ru" in url, "Не работает ссылка на сайт КИОН"
    #
    #     selector = self.browser.find_element(*StartMusicLocators.BUTTON_BUY_169)
    #     WDW(self.browser, 5).until(EC.element_to_be_clickable((selector))).click()
    #     assert self.check_exists_element(*StartMusicLocators.BUTTON_BUY_169), "Кнопка 'Купить за 169р' не отображается"
