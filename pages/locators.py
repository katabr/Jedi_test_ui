...
class AdminLocators():
    ...
    BUTTON_CREATE_CHAT_WITH_USER = (By.XPATH, '//span[text()="Создать чат c пользователем"]')
    ...
    TEXT_BEGIN_CHAT = (By.XPATH, '//*[text()[contains(.," начал чат")]]')
...
class PadavanLocators():
    ...
    BUTTON_MENU_PROFILE = (By.XPATH, '//*[text()="Раскрыть меню редактирования"]')
    BUTTON_MISSION = (By.XPATH, '//div[text()="Миссии"]')
    BUTTON_OPINION = (By.XPATH, '//*[text()="Открытый отзыв"]')
    BUTTON_OUTPUT_TASK = (By.XPATH, '//*[text()="Выпускное задание"]')
    BUTTON_PROFILE = (By.XPATH, '//*[text()="Профиль"]')
    BUTTON_REACTION = (By.XPATH, '//*[text()="Оценить дисциплину"]')
    BUTTON_SEND_REQUEST = (By.XPATH, '//*[text()="Отправить заявку"]')
    BUTTON_TASKS = (By.XPATH, '//button[text()="Занятия"]')
    BUTTON_TIMETABLE = (By.XPATH, '//button[text()="Расписание"]')
    FIELD_NAME = (By.CSS_SELECTOR, 'div:empty')   #'input.el-input__inner>#shadow-root>div')
    TEXT_FIELD_NAME = "Тестовое имя"
    FIELD_OPINION = (By.CSS_SELECTOR,'#placeholder')
    LOGIN = (By.CSS_SELECTOR,'.el-input__inner[type="text"]')
    PASSWORD = (By.CSS_SELECTOR,'.el-input__inner[type="password"]')
    TEXT_ABLE_OUTPUT_TASKS = (By.XPATH, '//*[text()= "Доступные выпускные задания"]')
    TEXT_AREA_OPINION = (By.CSS_SELECTOR, '.el-textarea__inner')
    TEXT_BEGIN_CHAT = (By.XPATH, '//*[text()[contains(.," начал чат")]]')
    TEXT_HEADER_CHAT = (By.XPATH, '//h1[text()="Чаты"]')
    TEXT_HEADER_LESSONS = (By.XPATH, '//h1[text()="Предметы"]')
    TEXT_HEADER_MISSION = (By.XPATH, '//h3[text()="Миссии на неделю"]')
